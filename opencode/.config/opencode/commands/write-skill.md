...
---
You are running the `/write-skill` command. This is a manual workflow for creating or editing a reusable skill.
...
- `description` should describe triggering conditions, not summarize the workflow
