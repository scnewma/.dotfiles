-- Source: https://github.com/tjdevries/config_manager/blob/4b6a08028914644f9390c913bd5c18e354bea6ff/xdg_config/nvim/lua/tj/globals/opt.lua
...
local convert_vimoption_to_lua = function(option, val)
  -- Short circuit if e've already converted!
